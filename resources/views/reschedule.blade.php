...
<div class="card">
    ...
    @endif
        ...
        <div class="form-group">
            ...
            <input type="date" id="tanggal_mulai" name="tanggal_mulai" value="{{ $pesanan->tanggal_mulai }}" required>
        </div>

        <!-- Tanggal Selesai -->
        <div class="form-group">
            <label for="tanggal_selesai">Tanggal Selesai</label>
            <input type="date" id="tanggal_selesai" name="tanggal_selesai" value="{{ $pesanan->tanggal_selesai }}" required>
        </div>
